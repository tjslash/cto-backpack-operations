...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'tjslash.cto-backpack-operations::fields',
]);
```
...
cp -i vendor/tjslash/cto-backpack-operations/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove tjslash/cto-backpack-operations
```
